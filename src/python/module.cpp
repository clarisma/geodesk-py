...
static PyMethodDef GEODESK_METHODS[] = 
{
    ...
    { "area", (PyCFunction)PyMercator::area, METH_VARARGS | METH_KEYWORDS,
"Computes the area of a Feature, Geometry or Box"},
    { "length", (PyCFunction)PyMercator::length, METH_VARARGS | METH_KEYWORDS,
"Computes the length of a Feature or Geometry"},
