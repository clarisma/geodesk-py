...
CoordSequenceSlicer::CoordSequenceSlicer(GEOSContextHandle_t context, const GEOSCoordSequence* coords) :
...
void CoordSequenceSlicer::slice(MonotoneChain* chain, int maxVertexes)
{
