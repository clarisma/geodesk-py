...
object_keys = {
    ...
    "railway", "road_marking", "route", "seamark:type", "shop", "surveillance", "telecom", "tourism", 
...
group_prefixes = { "addr", "TMC", "ele", "historic", "railway" }

lifecycle_prefixes = { "abandoned", "disused", "razed", "removed", "was" }
